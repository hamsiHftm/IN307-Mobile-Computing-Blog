...
final ThemeData blogThemeLight = ThemeData(
  ...
  colorScheme: const ColorScheme.light(
    primary: Color(0xFFD12B41),
    // Primary Color
    secondary: Color(0xFF412349),
    tertiary: Colors.white,
    // Secondary Color
    onPrimaryContainer: Color(0xFFD12B41),
    // Primary Color
  ...
  textTheme: const TextTheme(
    displayLarge: TextStyle(
        fontSize: 36.0, fontWeight: FontWeight.bold, color: Color(0xFFD12B41)),
    ...
    headlineLarge: TextStyle(
        fontSize: 20.0, fontWeight: FontWeight.w600, color: Color(0xFFD12B41)),
    headlineMedium: TextStyle(
        fontSize: 18.0, fontWeight: FontWeight.w600, color: Color(0xFFD12B41)),
    headlineSmall: TextStyle(
        fontSize: 16.0, fontWeight: FontWeight.w500, color: Color(0xFFD12B41)),
    bodyLarge: TextStyle(
        fontSize: 16.0,
        fontWeight: FontWeight.normal,
        color: Color(0xFF412349)),
    bodyMedium: TextStyle(
        fontSize: 14.0,
        fontWeight: FontWeight.normal,
        color: Color(0xFFE4A49B)),
    bodySmall: TextStyle(
        fontSize: 12.0,
        fontWeight: FontWeight.normal,
        color: Color(0xFF412349)),
    labelLarge: TextStyle(
        fontSize: 14.0, fontWeight: FontWeight.w600, color: Color(0xFFE4A49B)),
    labelMedium: TextStyle(
        fontSize: 12.0, fontWeight: FontWeight.w600, color: Color(0xFFE4A49B)),
    labelSmall: TextStyle(
        fontSize: 10.0, fontWeight: FontWeight.w600, color: Color(0xFFE4A49B)),
  ),
